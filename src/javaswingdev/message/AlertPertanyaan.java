...
public class AlertPertanyaan extends javax.swing.JDialog {
    ...
    public AlertPertanyaan(JFrame fram) {
        super(fram, true);
        this.fram = fram;
        initComponents();
        init();
    ...
    private void initComponents() {
        ...
        lbIcon.setIcon(new javax.swing.ImageIcon(getClass().getResource("/main/img/Alert/segitiga.png"))); // NOI18N
        jPanel1.add(lbIcon);
        lbIcon.setBounds(0, 100, 380, 160);

        cmdCancel.setBackground(new java.awt.Color(255, 255, 255));
        cmdCancel.setIcon(new javax.swing.ImageIcon(getClass().getResource("/main/img/Alert/btn-alert-3.png"))); // NOI18N
        ...
        cmdOK.setIcon(new javax.swing.ImageIcon(getClass().getResource("/main/img/Alert/btn-alert.png"))); // NOI18N
...
cmdCancel.setIcon(new javax.swing.ImageIcon(getClass().getResource("/main/img/Alert/btn-alert-3-hover.png")));
    ...
    private void cmdCancelMouseExited(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_cmdCancelMouseExited
        // TODO add your handling code here:
cmdCancel.setIcon(new javax.swing.ImageIcon(getClass().getResource("/main/img/Alert/btn-alert-3.png")));
    ...
    private void cmdCancelMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_cmdCancelMousePressed
        // TODO add your handling code here:
cmdCancel.setIcon(new javax.swing.ImageIcon(getClass().getResource("/main/img/Alert/btn-alert-3-clicked.png")));
...
cmdCancel.setIcon(new javax.swing.ImageIcon(getClass().getResource("/main/img/Alert/btn-alert-3.png")));
    ...
    private void cmdOKMouseEntered(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_cmdOKMouseEntered
        // TODO add your handling code here:
cmdOK.setIcon(new javax.swing.ImageIcon(getClass().getResource("/main/img/Alert/btn-alert-hover.png")));
    ...
    private void cmdOKMouseExited(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_cmdOKMouseExited
        // TODO add your handling code here:
cmdOK.setIcon(new javax.swing.ImageIcon(getClass().getResource("/main/img/Alert/btn-alert.png")));
    ...
    private void cmdOKMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_cmdOKMousePressed
        // TODO add your handling code here:
cmdOK.setIcon(new javax.swing.ImageIcon(getClass().getResource("/main/img/Alert/btn-alert-clicked.png")));
...
if (evt.getKeyCode()==KeyEvent.VK_ENTER){
              messageType = AlertPertanyaan.MessageType.OK;
        closeMessage();
}
