...
private ImageIcon format = null;
    ...
    void Cursor(){
        ...
        jswitch.setCursor(new java.awt.Cursor(java.awt.Cursor.HAND_CURSOR));
...
void panggilAlertMerah(String Title, String message){
    ...
    private void initComponents() {
        ...
        jPanel1.add(jtgl);
        jtgl.setBounds(900, 117, 230, 50);

        jswitch.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jswitch.setIcon(new javax.swing.ImageIcon(getClass().getResource("/main/img/Trans/beli.png"))); // NOI18N
        jswitch.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                jswitchMouseClicked(evt);
            }
            public void mouseEntered(java.awt.event.MouseEvent evt) {
                jswitchMouseEntered(evt);
            }
            public void mouseExited(java.awt.event.MouseEvent evt) {
                jswitchMouseExited(evt);
            }
            public void mousePressed(java.awt.event.MouseEvent evt) {
                jswitchMousePressed(evt);
            }
            public void mouseReleased(java.awt.event.MouseEvent evt) {
                jswitchMouseReleased(evt);
            }
        });
        jPanel1.add(jswitch);
        jswitch.setBounds(1140, 120, 90, 50);
    ...
    private void jswitchMouseEntered(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jswitchMouseEntered
        // TODO add your handling code here:
jswitch.setIcon(new javax.swing.ImageIcon(getClass().getResource("/main/img/Trans/beli-hover.png")));
    }//GEN-LAST:event_jswitchMouseEntered

    private void jswitchMouseExited(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jswitchMouseExited
        // TODO add your handling code here:
jswitch.setIcon(new javax.swing.ImageIcon(getClass().getResource("/main/img/Trans/beli.png")));
    }//GEN-LAST:event_jswitchMouseExited
...
if (jtfkdbar.getText().equals("")) {
    ...
    private void jswitchMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jswitchMouseClicked
        // TODO add your handling code here:
                    TransaksiBeli transaksibeli = new TransaksiBeli();
                    transaksibeli.nama.setText(nama.getText());
                    transaksibeli.setVisible(true);
                    this.dispose();
    }//GEN-LAST:event_jswitchMouseClicked
...
popjend.setIcon(new javax.swing.ImageIcon(getClass().getResource("/main/img/popup/kembali.png")));
    ...
    private void jswitchMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jswitchMousePressed
        // TODO add your handling code here:
jswitch.setIcon(new javax.swing.ImageIcon(getClass().getResource("/main/img/Trans/beli-clicked.png")));
    }//GEN-LAST:event_jswitchMousePressed

    private void jswitchMouseReleased(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jswitchMouseReleased
        // TODO add your handling code here:
jswitch.setIcon(new javax.swing.ImageIcon(getClass().getResource("/main/img/Trans/beli.png")));
    }//GEN-LAST:event_jswitchMouseReleased
    ...
    void jcheckout() {
        try {
            String sqll = "insert into penjualan (id_penjualan, tanggal_transaksi, jam_transaksi, "
                    ...
                    "values ('" + jkdtrans.getText() + "', CURRENT_DATE, CURRENT_TIME, 0, 0, 0, '"+nama.getText()+"') ;";
            java.sql.Connection conn = (Connection) Config.configDB();
            java.sql.PreparedStatement pstl = conn.prepareStatement(sqll);
            pstl.execute();
