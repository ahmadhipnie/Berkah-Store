...
String filename = null, extension = ""; 
...
truncate.setCursor(new java.awt.Cursor(java.awt.Cursor.HAND_CURSOR));
...
class ImageFilter extends FileFilter {
   ...
   String getExtension(File f) {
    ...
    private void initComponents() {
        ...
        truncate = new javax.swing.JLabel();
        ...
        truncate.setIcon(new javax.swing.ImageIcon(getClass().getResource("/main/img/setting/btn-alert.png"))); // NOI18N
        truncate.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                truncateMouseClicked(evt);
            }
            public void mouseEntered(java.awt.event.MouseEvent evt) {
                truncateMouseEntered(evt);
            }
            public void mouseExited(java.awt.event.MouseEvent evt) {
                truncateMouseExited(evt);
            }
            public void mousePressed(java.awt.event.MouseEvent evt) {
        ...
        jPanel1.add(truncate);
        truncate.setBounds(290, 620, 940, 43);
...
Files.copy(sourceFile.toPath(),destinationFile.toPath());
    ...
    private void upfotoMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_upfotoMouseClicked
        // TODO add your handling code here:
            ...
            chooser.addChoosableFileFilter(new Setting.ImageFilter());
...
jPanel1.setVisible(false);
    ...
    private void truncateMouseReleased(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_truncateMouseReleased
        // TODO add your handling code here:
        truncate.setIcon(new javax.swing.ImageIcon(getClass().getResource("/main/img/setting/btn-alert.png")));
    ...
    private void truncateMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_truncateMousePressed
        // TODO add your handling code here:
        truncate.setIcon(new javax.swing.ImageIcon(getClass().getResource("/main/img/setting/btn-alert-clicked.png")));
    }//GEN-LAST:event_truncateMousePressed

    private void truncateMouseExited(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_truncateMouseExited
        // TODO add your handling code here:
        truncate.setIcon(new javax.swing.ImageIcon(getClass().getResource("/main/img/setting/btn-alert.png")));
    }//GEN-LAST:event_truncateMouseExited

    private void truncateMouseEntered(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_truncateMouseEntered
        // TODO add your handling code here:
        truncate.setIcon(new javax.swing.ImageIcon(getClass().getResource("/main/img/setting/btn-alert-hover.png")));
    }//GEN-LAST:event_truncateMouseEntered

    private void truncateMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_truncateMouseClicked
        // TODO add your handling code here:
        AlertPertanyaan obj = new AlertPertanyaan(this);
        obj.showMessage("Konfirmasi Hapus riwayat", "apakah anda yakin untuk menghapus semua riwayat aplikasi?");
        if (obj.getMessageType() == AlertPertanyaan.MessageType.OK) {
            try {
                String sqll = "Delete from retur_supplier ;";
                java.sql.Connection connn = (Connection) Config.configDB();
                java.sql.PreparedStatement pstl = connn.prepareStatement(sqll);
                pstl.execute();
                panggilAlertHijau("Berhasil!", "Berhasil Menghapus semua riwayat");
            } catch (Exception e) {
                panggilAlertMerah("Gagal", "Penghapusan riwayat gagal");
                e.printStackTrace();
            }
            try {
                String sqll = "Delete from retur_customer ;";
                java.sql.Connection connn = (Connection) Config.configDB();
                java.sql.PreparedStatement pstl = connn.prepareStatement(sqll);
                pstl.execute();
            } catch (Exception e) {
            ...
            try {
                String sqll = "Delete from penjualan ;";
                java.sql.Connection connn = (Connection) Config.configDB();
                java.sql.PreparedStatement pstl = connn.prepareStatement(sqll);
                pstl.execute();
            } catch (Exception e) {
            ...
            try {
                String sqll = "Delete from pembelian ;";
                java.sql.Connection connn = (Connection) Config.configDB();
                java.sql.PreparedStatement pstl = connn.prepareStatement(sqll);
                pstl.execute();
            } catch (Exception e) {
    ...
    private javax.swing.JLabel truncate;
